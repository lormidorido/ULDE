...
=head1 TABLE: C<product_document_templates>

=cut

__PACKAGE__->table("product_document_templates");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:l1oeoYmzqps+UN0wWODp9g
