...
=head1 TABLE: C<document_template_jurisdictions>

=cut

__PACKAGE__->table("document_template_jurisdictions");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:/pO7+HIK1MPmR1GCYVudQg
