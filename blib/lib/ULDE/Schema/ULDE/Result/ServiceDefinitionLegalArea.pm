...
=head1 TABLE: C<service_definition_legal_areas>

=cut

__PACKAGE__->table("service_definition_legal_areas");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:k/fHwJxt3jGxioZrZtxOhw
