...
=head1 TABLE: C<document_template_versions>

=cut

__PACKAGE__->table("document_template_versions");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tpE0wGVSlw7J72hoEoVEog
