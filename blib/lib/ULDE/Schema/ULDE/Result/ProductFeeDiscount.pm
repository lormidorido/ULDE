use utf8;
package ULDE::Schema::ULDE::Result::ProductFeeDiscount;
...
=head1 TABLE: C<product_fee_discounts>

=cut

__PACKAGE__->table("product_fee_discounts");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:uSZKIpL9EY3F0ZmGR1t70A
