use utf8;
package ULDE::Schema::ULDE::Result::ActivityTemplateInstance;
...
=head1 TABLE: C<activity_template_instance>

=cut

__PACKAGE__->table("activity_template_instance");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OzQOgBnyMrPuEztoFvYpBw
