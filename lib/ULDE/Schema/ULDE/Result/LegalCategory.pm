use utf8;
package ULDE::Schema::ULDE::Result::LegalCategory;
...
=head1 TABLE: C<legal_category>

=cut

__PACKAGE__->table("legal_category");
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'legal_categories_id_seq'
...
=head2 sub_categories

Type: many_to_many

Composing rels: L</category_sub_category_relations> -> sub_category
...
# Created by DBIx::Class::Schema::Loader v0.07043 @ 2015-07-30 04:52:49
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GP1pp/BAO4i1MHSbYdxXTg
