use utf8;
package ULDE::Schema::ULDE::Result::ReviewerRole;
...
=head1 TABLE: C<reviewer_role>

=cut

__PACKAGE__->table("reviewer_role");
...
__PACKAGE__->set_primary_key("reviewer", "role");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2VZqzzFHwUBASdJI6MycoQ
