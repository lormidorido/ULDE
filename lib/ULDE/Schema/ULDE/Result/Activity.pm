use utf8;
package ULDE::Schema::ULDE::Result::Activity;
...
Related object: L<ULDE::Schema::ULDE::Result::ActivityCode>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DloaMs9uxS/99BM6JnGbJA
