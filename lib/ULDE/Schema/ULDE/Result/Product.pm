...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SUqOePJIfoiBIUy5dld3zg

__PACKAGE__->many_to_many("service_definitions", "product_service_definitions", "service_definition");

__PACKAGE__->many_to_many("document_templates", "product_document_templates", "document_template");
